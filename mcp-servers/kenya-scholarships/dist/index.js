...
class KenyaScholarshipsMCPServer {
            ...
            tools: [
                {
                    ...
                    description: 'Fetch scholarships from Kenya Ministry of Education website (education.go.ke/scholarships). Returns structured scholarship data including name, provider, deadline, eligibility, and application links.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            limit: {
                ...
                },
                {
                    ...
                    description: 'Fetch NG-CDF (National Government Constituency Development Fund) bursary information. Includes county-specific bursaries and application deadlines.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            county: {
                ...
                },
                {
                    ...
                    description: 'Fetch county-specific bursary programs. Includes information from county government portals.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            county: {
                ...
                },
                {
                    ...
                    description: 'Search across all Kenyan scholarship sources (Ministry, NG-CDF, Counties) with filters.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            query: {
                ...
                },
                {
                    ...
                    description: 'Get detailed information about a specific scholarship by name or ID.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            name: {
                    ...
                    case 'fetch_ministry_scholarships':
                        ...
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: JSON.stringify(await this.scrapers.ministry.fetchScholarships({
                    ...
                    case 'fetch_ngcdf_bursaries':
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: JSON.stringify(await this.scrapers.ngcdf.fetchBursaries({
                    ...
                    case 'fetch_county_bursaries':
                        ...
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: JSON.stringify(await this.scrapers.county.fetchBursaries(county), null, 2),
                                },
                            ],
                        };
                    case 'search_scholarships':
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: JSON.stringify(await this.searchAllSources(args || {}), null, 2),
                                },
                            ],
                        };
                    case 'get_scholarship_details':
                        ...
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: JSON.stringify(await this.getScholarshipDetails(scholarshipName, scholarshipSource), null, 2),
                                },
                            ],
                        };
                    default:
    ...
    async getScholarshipDetails(name, source) {
        ...
        for (const src of sources) {
            try {
                ...
                const match = data.find((s) => s.name?.toLowerCase().includes(name.toLowerCase()));
                if (match)
                    results.push(match);
            }
            catch (error) {
